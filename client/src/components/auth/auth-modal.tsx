                ...
                {view === 'login' ? (
                    <div>
                                        ...
                                        <FormItem>
                                            <FormControl>
                                                <div className="relative">
                                                    <div className={cn(
                                                        "absolute top-1/2 -translate-y-1/2 w-11 h-11 flex items-center justify-center pointer-events-none",
                        ...
                        <div className="text-center">
                            ...
                            <Button
                                variant="outline"
                                className="w-full h-11 rounded-xl font-medium border-2 hover:bg-primary/5 hover:border-primary/30"
                    ...
                    <div>
                        ...
                        <Form {...registerForm}>
                            <form onSubmit={registerForm.handleSubmit((data) => registerMutation.mutate(data))} className="space-y-3">
                                ...
                                <Button
                                    type="submit"
                                    className="w-full h-12 rounded-xl text-base font-semibold shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 mt-2"
