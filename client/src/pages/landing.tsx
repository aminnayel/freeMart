      ...
      <div className="relative z-10">
        ...
        <main className="container mx-auto px-4 py-16">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            ...
            <Button asChild size="lg" className="text-lg px-8 py-6 bg-gradient-primary hover:shadow-primary-lg glow-on-hover transition-all duration-300 hover:scale-105" data-testid="button-get-started">
              <a href="/auth">{t('get_started')}</a>
            </Button>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
              <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
              ...
              <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
                <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-accent flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
